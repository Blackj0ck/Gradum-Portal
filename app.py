            ...
            <div class="communication-grid">
                <div class="panel">
                    ...
                    <div class="chat-input">
                        <textarea id="${id}-chat-input" placeholder="Escribe un mensaje para el equipo de Gradum..."></textarea>
                        <button class="btn" onclick="sendMessage('${id}','Cliente')">Enviar</button>
                    </div>
...
function seedChat(id){
    let messages = getChatStore(id);
    if(messages.length){return messages;}

    messages = [
        {sender:"Gradum", text:"Bienvenido al canal del proyecto. Aquí puedes dejar preguntas, solicitudes y confirmaciones.", date:"Inicio"},
        {sender:"Cliente", text:"Perfecto. Usaré este espacio para dar seguimiento a los entregables.", date:"Inicio"}
    ];
...
function renderChat(id){
    ...
    box.innerHTML = messages.map(m => `
        <div class="message ${m.sender === 'Cliente' ? 'client' : 'gradum'}">
...
function sendGradumReply(id){
    const replies = [
        "Recibido. Lo revisamos y te confirmamos por este mismo canal.",
        "Sí, esta es la última versión disponible para revisión.",
